...
public class FramePeople {
    ...
    public String getSuperDes() {
        return superDes;
    }

    public void setSuperDes(String superDes) {
        this.superDes = superDes;
    }
    ...
    public String getFamiliarChina() {
        return familiarChina;
    }

    public void setFamiliarChina(String familiarChina) {
        this.familiarChina = familiarChina;
    }
